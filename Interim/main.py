...
# ============ Config ============
CONFIG = {
    "model_name": "resnet50",  # "resnet50" | "efficientnetb7" | "mobilenetv3"
    "data_dir": "D:/DeepFake/pythonProject1/New1/deepfake_database",  # root folder containing train/ val/ test/
    "epochs": 20,
    "batch_size": 32,
    "seed": 42,
    "base_trainable_at": None,  # e.g., -30 to fine-tune last 30 layers after warmup; None = freeze all base
    "warmup_epochs": 3,  # epochs with base frozen before optional fine-tune
    "learning_rate": 1e-3,
    "fine_tune_lr": 1e-4,  # used after unfreezing
    "use_class_weights": False,  # set True if your classes are imbalanced
    "mixed_precision": True,  # set True if you have a GPU that benefits (e.g., Ampere)
    "output_dir": "D:/DeepFake/pythonProject1/New1",
}
...
def train():
    ...
    # Save final model
    final_path = os.path.join(CONFIG["output_dir"], "resnet50.keras")
